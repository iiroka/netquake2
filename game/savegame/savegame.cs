    ...
    partial class QuakeGame
    {
        ...
        */
        private readonly field_t[] fields = {
            ...
            new field_t(){ name = "delay", fname="delay", type = fieldtype_t.F_FLOAT },
            new field_t(){ name = "random", fname="random", type = fieldtype_t.F_FLOAT },
            // {"move_origin", FOFS(move_origin), F_VECTOR},
            // {"move_angles", FOFS(move_angles), F_VECTOR},
            new field_t(){ name = "style", fname="style", type = fieldtype_t.F_INT },
            new field_t(){ name = "count", fname="count", type = fieldtype_t.F_INT },
            new field_t(){ name = "health", fname="health", type = fieldtype_t.F_INT },
            new field_t(){ name = "sounds", fname="sounds", type = fieldtype_t.F_INT },
            new field_t(){ name = "light", fname="light", type = fieldtype_t.F_IGNORE },
            new field_t(){ name = "dmg", fname="dmg", type = fieldtype_t.F_INT },
            new field_t(){ name = "mass", fname="mass", type = fieldtype_t.F_INT },
            new field_t(){ name = "volume", fname="volume", type = fieldtype_t.F_FLOAT },
            new field_t(){ name = "attenuation", fname="attenuation", type = fieldtype_t.F_FLOAT },
            ...
            new field_t(){name="lip", fname="lip", type=fieldtype_t.F_INT, flags=FFL_SPAWNTEMP},
            new field_t(){name="distance", fname="distance", type=fieldtype_t.F_INT, flags=FFL_SPAWNTEMP},
            new field_t(){name="height", fname="height", type=fieldtype_t.F_INT, flags=FFL_SPAWNTEMP},
            new field_t(){name="noise", fname="noise", type=fieldtype_t.F_LSTRING, flags=FFL_SPAWNTEMP},
            new field_t(){name="pausetime", fname="pausetime", type=fieldtype_t.F_FLOAT, flags=FFL_SPAWNTEMP},
            new field_t(){name="item", fname="item", type=fieldtype_t.F_LSTRING, flags=FFL_SPAWNTEMP},
